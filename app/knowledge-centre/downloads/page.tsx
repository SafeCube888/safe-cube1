...
export const metadata: Metadata = {
  title: 'Downloads | SAFE CUBE Knowledge Centre',
  description:
    'Download practical workplace safety templates, registers, checklists, and forms for your workplace.',
  alternates: { canonical: '/knowledge-centre/downloads' },
};
...
export default function DownloadsPage() {
  return (
    <>
      <PageHero
        breadcrumbs={[{ label: 'Home', href: '/' }, { label: 'Knowledge Centre', href: '/knowledge-centre' }, { label: 'Downloads' }]}
        eyebrow="DOWNLOADS"
        title="Downloads"
        description="Download practical workplace safety templates, registers, checklists, and forms designed to support your daily and periodic workplace activities."
      ...
      <section className="section-standard bg-white">
        <Container>
          <div className="mb-10 text-center">
            ...
            <SectionHeading className="mt-3" as="h2">Available Downloads</SectionHeading>
      ...
      <section className="section-standard bg-cube-soft">
        <Container>
          <CTADark
            heading="Need Help Using These Resources?"
            text="SAFE CUBE can help you implement these templates and systems in your workplace. Start with a free CUBE SCORE or contact us for support."
