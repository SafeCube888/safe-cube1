...
export const metadata: Metadata = {
  title: 'CUBE SCORE Requests | SAFE CUBE Admin',
};
...
export default async function AdminCubeScorePage() {
  try {
    ...
    return (
      <LeadPageClient
        title="CUBE SCORE Requests"
        records={(data || []) as LeadRecord[]}
        columns={columns}
        tableName="cube_score_requests"
      />
    );
  } catch {
    return (
      <div className="space-y-6">
        <h1 className="text-2xl font-bold text-cube-navy">CUBE SCORE Requests</h1>
